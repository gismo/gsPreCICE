...
// ----------------------------------------------------------------------------------------------
    ...
    // get from XML ???
    gsMatrix<> quad_stress(3,quad_xy.cols());
    ...
    bcInfo.addCondition(0, boundary::front, condition_type::dirichlet, &g_D, 2);
    bcInfo.addCondition(0, boundary::back, condition_type::dirichlet, &g_D, 2);
    // Assign geometry map
