...
int main(int argc, char *argv[])
{
    ...
    gsReadFile<>(filenameBeam, patches);
...
// ----------------------------------------------------------------------------------------------
    ...
    // Add all BCs
    // Coupling interface
    bcInfo.addCondition(0, boundary::south,  condition_type::neumann , &g_C,-1,true);
    ...
    bcInfo.addCondition(0, boundary::west, condition_type::dirichlet, &g_D, 0);
